...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://eld-frontend-staging-1018057487898.us-east1.run.app"
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'knox.auth.TokenAuthentication',  # For API - check first
...
REST_KNOX = {
    ...
    'TOKEN_LIMIT_PER_USER': 10,  # Maximum 10 active tokens per user
    'AUTO_REFRESH': True,
